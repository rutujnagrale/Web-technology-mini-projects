...
$sql = "USE book_store";
$conn->query($sql);
$sql = "INSERT INTO users(username, password) VALUES('" . $uname . "', '" . 
$upassword . "')";
$conn->query($sql);
...
$sql = "INSERT INTO customer(customer_name, ustomer_phone, ustomer_ic, 
customer_email, customer_address, customer_gender, user_id) 
VALUES('" . $name . "', '" . $contact . "', '" . $ic . "', '" . $email . "', '"
. $address . "', '" . $gender . "', " . $id . ")";
$conn->query($sql);
